...
async def status_task():
	...
	for shard_id in shard_ids:
		await bot.change_presence(activity=disnake.Activity(state=f'{len(shard_ids)} shards', type=disnake.ActivityType.competing, name=f'{len(bot.guilds)} Servers | {len(humans)} Humans', shard_id=shard_id))
